...
$statement->bindValue(":id",$_GET["gid"]);
$statement->execute();
$groups = $statement->fetchAll(PDO::FETCH_ASSOC);
if($_SERVER["REQUEST_METHOD"]=="POST"){
    $title=$_POST["title"];
    $desc = $_POST["desc"];
    $statement=$pdo->prepare("INSERT INTO sub_groups(gid,title,description) VALUES(:gid,:title,:desc)");
    $statement->bindValue(":gid",$_GET["gid"]);
                            ...
                            <div class="col-lg-7 mb-4">
                                ...
                                <div class="mb-2 d-flex justify-content-between align-center mt-4 mr-2">
                                    <div class="info ml-3">
                                        ...
                                        <p class="fw-light">Below is a list of all the licences available</p>
                                    </div>
                                    <!-- <div class="mr-3">
